/* Actividad 6 - Elementos BBDD y vistas
 * Grupo_07 Himar y Cristian
 * Actividad realizada en MySQL
 */

/* ----------- CREACION BBDD ----------*/
CREATE DATABASE IF NOT EXISTS PatrimonioNatural;

use PatrimonioNatural;
...
select * from patrimonionatural.visitantes_pie;